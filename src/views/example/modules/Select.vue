<template>
  <Card title="select">
    ...
    <div>
      <c-enterprise-select show-search width="180px" v-model:value="selectState.enterprise"></c-enterprise-select>
      <c-dept-tree-select
        :enterpriseId="selectState.enterprise"
        show-search
        style="width: 180px"
      ></c-dept-tree-select>
      <c-position-select show-search width="180px" :enterpriseId="selectState.enterprise"></c-position-select>
      <c-enterprise-tree-select style="width: 200px"></c-enterprise-tree-select>
    </div>
  </Card>
</template>
